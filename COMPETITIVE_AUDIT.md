...
6. **Dogfooding enforcement** — The wizard tests itself. Every PR to this repo runs the same SDLC evaluation we recommend for users. Comprehensive automated tests across 22 scripts.
